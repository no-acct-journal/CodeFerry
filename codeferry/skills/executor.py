...
from codeferry.skills.parser import SkillDef, substitute_arguments
from codeferry.tools import ToolRegistry

if TYPE_CHECKING:
    from codeferry.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from codeferry.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
