...
from codeferry.skills.parser import SkillDef, SkillParseError, parse_frontmatter, parse_skill_file

log = logging.getLogger(__name__)

PROJECT_SKILLS_DIR = ".codeferry/skills"
USER_SKILLS_DIR = "~/.codeferry/skills"
...
class SkillLoader:
    ...
    def _load_builtins(self) -> list[SkillDef]:
        results: list[SkillDef] = []
        builtins_pkg = importlib.resources.files("codeferry.skills.builtins")
        ...
        for resource in builtins_pkg.iterdir():
            ...
            try:
                ...
                from codeferry.skills.parser import _validate_meta
