...
PROJECT_AGENTS_DIR = ".codeferry/agents"
USER_AGENTS_DIR = "~/.codeferry/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("codeferry.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from codeferry.agents.parser import parse_frontmatter, _validate_agent_meta
    ...
    def load_all(self) -> dict[str, AgentDef]:
        ...
        # Priority 4: plugins (reserved, not implemented).
