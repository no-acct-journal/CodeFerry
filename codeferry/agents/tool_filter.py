...
def resolve_agent_tools(
    ...
    # Layer 0: MCP tools are always allowed; separate them before further filtering.
    ...
    # Layer 1: globally disallowed tools.
    ...
    # Layer 3: background task allowlist.
    if is_background:
        all_tools = {
            name: tool
    ...
    # Layer 4: filter by the agent definition's disallowed/allowed lists.
...
def build_teammate_tools(
    ...
    from codeferry.tools.send_message import SendMessageTool
    from codeferry.tools.task_create import TaskCreateTool
    from codeferry.tools.task_get import TaskGetTool
    from codeferry.tools.task_list import TaskListTool
    from codeferry.tools.task_update import TaskUpdateTool
