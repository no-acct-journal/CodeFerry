...
from codeferry.teams.mailbox import Mailbox, create_message
...
from codeferry.teams.progress import TeammateProgress
from codeferry.teams.registry import AgentNameRegistry
from codeferry.teams.shared_task import SharedTaskStore
from codeferry.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from codeferry.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
