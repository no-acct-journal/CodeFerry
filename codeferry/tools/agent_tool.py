...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from codeferry.agents.fork import ForkError, build_forked_messages
        from codeferry.agents.parser import AgentDef
        from codeferry.agents.tool_filter import resolve_agent_tools
        from codeferry.agent import Agent as AgentClass
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from codeferry.agents.fork import ForkError, build_forked_messages
        from codeferry.agents.parser import AgentDef
        from codeferry.agents.tool_filter import build_teammate_tools
        from codeferry.agent import Agent as AgentClass
        from codeferry.conversation import ConversationManager
        from codeferry.permissions import (
            DangerousCommandDetector,
        ...
        from codeferry.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from codeferry.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from codeferry.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from codeferry.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from codeferry.client import create_client
